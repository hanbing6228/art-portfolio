...
(function () {
  ...
  window.FACES = [
    ...
    { e: "😡", s: F(FB.r, '<path d="M11.5 13l5.5 2.2M28.5 13l-5.5 2.2" stroke="' + FD + '" stroke-width="2" stroke-linecap="round"/>' + dot(14.5, 18) + dot(25.5, 18) + '<path d="M15 27q5-3.5 10 0" stroke="' + FD + '" stroke-width="2.2" fill="none" stroke-linecap="round"/>') },
    { e: "😘", s: F(FB.t, dot(14.5, 16) + '<path d="M23 16q2.5-2.2 5 0" stroke="' + FD + '" stroke-width="2.2" fill="none" stroke-linecap="round"/><circle cx="18" cy="25.5" r="2.2" fill="none" stroke="' + FD + '" stroke-width="2"/><path d="M25 22c1.6-1.6 4 .6 2.2 2.4L25 26.6l-2.2-2.2c-1.8-1.8.6-4 2.2-2.4z" fill="' + FB.r + '"/>') },
    { e: "🤩", s: F(FB.y, '<path d="M14.5 12l1.3 3.2 3.4.2-2.6 2.2.9 3.3-3-1.9-3 1.9.9-3.3-2.6-2.2 3.4-.2z" fill="' + FD + '"/><path d="M25.5 12l1.3 3.2 3.4.2-2.6 2.2.9 3.3-3-1.9-3 1.9.9-3.3-2.6-2.2 3.4-.2z" fill="' + FD + '" transform="translate(0,0)"/><path d="M13 25a7 5 0 0 0 14 0z" fill="' + FD + '"/>') },
    { e: "😴", s: F(FB.b, '<path d="M11.5 16.5q3-2.5 6 0M22.5 16.5q3-2.5 6 0" stroke="' + FD + '" stroke-width="2" fill="none" stroke-linecap="round"/><circle cx="20" cy="26" r="2.2" fill="none" stroke="' + FD + '" stroke-width="1.8"/><path d="M28 9h4l-4 4h4" stroke="' + FD + '" stroke-width="1.4" fill="none" stroke-linejoin="round"/>') },
    { e: "🥳", s: F(FB.o, '<path d="M6 14l9-8 4 9z" fill="' + FB.t + '" stroke="' + FD + '" stroke-width="1.4"/>' + dot(16, 18) + dot(26, 18) + '<path d="M16 24a6 5 0 0 0 11 0z" fill="' + FD + '"/><circle cx="30" cy="12" r="1.2" fill="' + FB.r + '"/><circle cx="9" cy="24" r="1.2" fill="' + FB.g + '"/>') },
    { e: "😮", s: F(FB.y, dot(14.5, 15.5) + dot(25.5, 15.5) + '<ellipse cx="20" cy="26" rx="3.2" ry="4" fill="' + FD + '"/>') },
    { e: "🤓", s: F(FB.g, '<circle cx="14.5" cy="16" r="4" fill="#fff" stroke="' + FD + '" stroke-width="1.8"/><circle cx="25.5" cy="16" r="4" fill="#fff" stroke="' + FD + '" stroke-width="1.8"/><path d="M18.5 16h3" stroke="' + FD + '" stroke-width="1.8"/>' + dot(14.5, 16) + dot(25.5, 16) + '<path d="M15 25q5 3 10 0" stroke="' + FD + '" stroke-width="2.2" fill="none" stroke-linecap="round"/>') },
    { e: "😳", s: F(FB.p, '<circle cx="14.5" cy="16" r="2.6" fill="none" stroke="' + FD + '" stroke-width="2"/><circle cx="25.5" cy="16" r="2.6" fill="none" stroke="' + FD + '" stroke-width="2"/><circle cx="10" cy="22" r="2.4" fill="' + FB.r + '" opacity="0.55"/><circle cx="30" cy="22" r="2.4" fill="' + FB.r + '" opacity="0.55"/><path d="M17 26h6" stroke="' + FD + '" stroke-width="2" stroke-linecap="round"/>') },
    { e: "😭", s: F(FB.b, '<path d="M11 17q3-3 6 0M23 17q3-3 6 0" stroke="' + FD + '" stroke-width="2.2" fill="none" stroke-linecap="round"/><ellipse cx="20" cy="27" rx="4" ry="3.5" fill="' + FD + '"/><path d="M13 19c-1.4 3-1.4 6 0 9M27 19c1.4 3 1.4 6 0 9" stroke="' + FB.b + '" stroke-width="2.4" fill="none" stroke-linecap="round"/>') },
  ];
